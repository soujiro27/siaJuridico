...
return yo`<form method="POST" class="form-inline" id="Caracteres">
   <div class="form-group siglas">
    <label for="siglas">Siglas</label>
    <input type="text" class="form-control" id="siglas" placeholder="siglas" required pattern="[A-Za-z].{1-2}" name="siglas" title="Maximo 2 caracteres">
</div>
